...
import type { VehicleDetailArrayResponseAllOf } from "./vehicleDetailArrayResponseAllOf";

export type VehicleDetailArrayResponse = BaseResponse &
	VehicleDetailArrayResponseAllOf;
