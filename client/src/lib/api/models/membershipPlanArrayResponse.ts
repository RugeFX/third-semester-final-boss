...
import type { MembershipPlanArrayResponseAllOf } from "./membershipPlanArrayResponseAllOf";

export type MembershipPlanArrayResponse = BaseResponse &
	MembershipPlanArrayResponseAllOf;
