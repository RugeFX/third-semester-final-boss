...
import type { ParkingLevelArrayResponseAllOf } from "./parkingLevelArrayResponseAllOf";

export type ParkingLevelArrayResponse = BaseResponse &
	ParkingLevelArrayResponseAllOf;
