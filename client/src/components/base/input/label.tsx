			...
			{tooltip && (
				...
				>
					<TooltipTrigger
						...
						// field is disabled.
						isDisabled={false}
						className="transition duration-200 cursor-pointer text-fg-quaternary hover:text-fg-quaternary_hover focus:text-fg-quaternary_hover"
					>
